...
This is a graphical user interface for interacting with Firefox's session store file that contains info about currently opened tabs and windows. It is implemented using [eframe](https://github.com/emilk/egui/tree/master/crates/eframe), a framework for writing apps using [egui](https://github.com/emilk/egui/).

The program can compile natively or for the web.
...
You can compile to [WASM](https://en.wikipedia.org/wiki/WebAssembly) and publish the app as a web page.
